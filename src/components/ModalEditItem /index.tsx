...
function ModalEditItem({handleChangeModal, handleChangeName, handleChangePrice, handleChangeDescription, handleChangeIdSelected, edit, data, name, price, description}: IRequest) {
    ...
    return (
        <Modal>
            ...
            <h1 className={"texto"}>Novo nome</h1>
            <input type="text" placeholder="Nome Novo Item" value={name} onChange={handleChangeName} />
            <h1 className={"texto"}>Nova Descrição</h1>
            <textarea placeholder="Descrição do item" value={description} onChange={handleChangeDescription} />
            <h1 className={"texto"}>Novo Preço</h1>
            <input type="text" placeholder="Preço" value={price} onChange={handleChangePrice} />
            ...
            <div className="icons">
                <CheckIcon className="icon" onClick={edit} />
